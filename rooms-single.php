      ...
      <div class="container">
        <div class="row">
          	...
          	<div class="row">
          		<div class="col-md-12 ftco-animate">
          			<div class="single-slider owl-carousel">
          				...
          				<div class="item">
          					<div class="room-img" style="background-image: url(frontend\ photos/room7.jpg);"></div>
          				</div>
                  <div class="item">
          					<div class="room-img" style="background-image: url(frontend\ photos/room7.jpg);"></div>
          				</div>
          		...
          		<div class="col-md-12 room-single mt-4 mb-5 ftco-animate">
          			<h2 class="mb-4" style="color:linear-gradient(to top, #aa7938, #aa7938, #d29751);">Luxury Room <span>- (2 Available rooms)</span></h2>
    						<p>A grand bedroom suite in coral blush with a Jaisalmer stone-laid private patio, marble fountains, and pool with jacuzzi. Covers 2,314 sq.ft.</p>
          ...
          <div class="col-lg-4 sidebar ftco-animate pl-md-5">
            ...
            <div class="sidebar-box ftco-animate" style="color:black;">
              <h3 style="color:#aa7938;">Paragraph</h3>
              <p>A grand bedroom suite in coral blush with a Jaisalmer stone-laid private patio, marble fountains, and pool with jacuzzi. Covers 2,314 sq.ft.!</p>
            </div>
            <a href="#" onclick="alert('Booked successfully')" class="btn btn-primary" style="color: white; background: linear-gradient(to top, #aa7938, #aa7938 33%, #d29751);">Book Now</a>
          </div>
        </div>
      </div>
