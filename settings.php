...
<div class="containe-fluid" id="main-content">
    <div class="row">
        <div class="col-lg-10 ms-auto p-4 overflow-hidden">
                    ...
                    <form>
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                ...
                                <button type="button" onclick="upd_general(site_title.value,site_about.value)" class="btn text-white shadow-none" style="background-color: blue;">SUBMIT</button>
                            </div>
                        </div>
                    </form>
                </div>
            ...
            <!-- shutdown -->
            <div class="card border-0 shadow-sm" style="margin-top:25px;">
                <div class="card-body">
                    <div class="d-flex align-items-center justify-content-between mb-3">
